...
class TestJ2Files(TestCase):
    ...
    def test_qos_dscp_remapping_render_template(self):
        ...
        sample_outputs = [
            ...
            'qos-arista7050cx3-dualtor-remap-enabled.json',
            'qos-arista7260-dualtor-remap-enabled.json',
            'qos-arista7260-t1-remap-enabled.json'
        ]
        sample_minigraph_files = [
            ...
            'sample-arista-7050cx3-dualtor-minigraph-remap-enabled.xml',
            'sample-arista-7260-dualtor-minigraph-remap-enabled.xml',
            'sample-arista-7260-t1-minigraph-remap-enabled.xml'
        ]
    ...
    def test_extra_lossless_buffer_for_tunnel_remapping(self):
        ...
        TEST_DATA = [
            ...
            ('arista', 'x86_64-arista_7050cx3_32s', 'Arista-7050CX3-32S-D48C8', 'sample-arista-7050cx3-dualtor-minigraph-remap-enabled.xml', 'buffers.json.j2', 'buffer-arista7050cx3-dualtor-remap-enabled.json'),
            ('arista', 'x86_64-arista_7260cx3_64', 'Arista-7260CX3-D108C8', 'sample-arista-7260-dualtor-minigraph-remap-enabled.xml', 'buffers.json.j2', 'buffer-arista7260-dualtor-remap-enabled.json'),
            ('arista', 'x86_64-arista_7260cx3_64', 'Arista-7260CX3-C64', 'sample-arista-7260-t1-minigraph-remap-enabled.xml', 'buffers.json.j2', 'buffer-arista7260-t1-remap-enabled.json')
        ]
